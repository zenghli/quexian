    ...
    <div style="width: 400px;padding-top: 10px;">
        <form id="form_submit" class="layui-form">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="biaozhun" lay-verify="required" placeholder="请输入缺陷标准" class="layui-input" value="">
                </div>
                ...
                <div class="layui-input-inline">
                    <input type="text" name="score" lay-verify="required|number" placeholder="请输入缺陷分数" class="layui-input" value="">
                </div>
